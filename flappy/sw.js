'use strict';
const CACHE = 'flappy-sky-club-nightmare-2';
const FILES = ['./', './index.html', './styles.css?v=nightmare-2', './core.js?v=nightmare-2', './audio.js?v=nightmare-2', './game.js?v=nightmare-2', './manifest.webmanifest?v=nightmare-2', './assets/bird.png', './assets/sky.webp', './assets/icon-192.png', './assets/icon-512.png', './assets/blood-moon.webp', './assets/bat.png'];
