...
หน้าอ่านจริงเป็นฉากภาพเต็มจอพร้อมบทพูดลอยบนภาพ: แตะ **อ่านต่อ** เพื่อดูช็อตถัดไป; เมื่อครบช่วง ทางเลือกจะอยู่ด้านบนของฉากและช่องพิมพ์อยู่ด้านล่าง กด **ก่อนหน้า** เพื่อย้อนดูช็อตที่อ่านแล้วโดยไม่ถอยเซฟหรือรับผลซ้ำ เปิด **บทสนทนา**, **สถานที่** และ **สถานะ** จากแถบเครื่องมือด้านบน เปิด **ดูภาพ** เพื่อซ่อนส่วนควบคุมชั่วคราว แล้วแตะฉากหรือกด Escape เพื่อกลับมา เปิด **อัตโนมัติ** เพื่อให้ระบบเดินช็อตที่เหลือโดยเว้นเวลาอ่านและหยุดรอเมื่อถึงทางเลือก ระบบไม่เลือกคำตอบแทนผู้เล่น ปุ่ม **แชต** ในแถบล่างพาเข้าเรื่องจริงโดยตรง
